...
import com.techsum.inamigos.photoeditor.MediaActivity
import com.techsum.inamigos.photoeditor.PhotoEditorActivity

class HomeScreenActivity : MediaActivity() {
  ...
  openGallery();//calling opengallery method
    ...
    @Override
    protected override fun onPhotoTaken() {
